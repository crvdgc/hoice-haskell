...
atLearner initialQuals arityMap learnDataset = let atLearnerLog = appendLabel "atLearner" hoiceLog
                                                ...
                                                in case propagate learnClass learnDataset of
                                                   ...
                                                   Just (learnClass', learnDataset') ->
                                                     let learnData = loggerShowId atLearnerLog "LearnData" $ LearnData learnClass' learnDataset' initialQuals
                                                         -- use the propagated learnData for decision tree learning
                                                      in learn arityMap learnData
  ...
  where
    ...
    iceRound funcMap knownDataset = do
      ...
      case eitherDataset of
        ...
        Right (Just dataset) -> let allDataset = loggerShowId atTeacherLog "dataset before simplify" $ dataset <> knownDataset
